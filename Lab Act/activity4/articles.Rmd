...
#url
url <- 'https://arxiv.org/search/?query=5G&searchtype=all&abstracts=show&order=-announced_date_first&size=50&start=0'
...
#saving articles to R data and csv
save(papers, file = "artilce_5G.RData")
write.csv(papers, file = "Arxivpaperson5G.csv")
